...
from backend.ppt_exporter import MTMPPTExporter, format_month_label, build_active_filters_summary
...
print(f"Loaded updated template with {len(prs.slides)} slides.")
