...
prs = Presentation('scratch/cover_placeholders_final.pptx')
slide0 = prs.slides[0]
print('=== Slide 0 Cover Final Inspection ===')
for i, shape in enumerate(slide0.shapes):
    ...
    print(f'Shape {i}: name={shape.name}, left={left:.2f}", top={top:.2f}", width={width:.2f}", height={height:.2f}"')
